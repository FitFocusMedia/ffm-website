...
export default function PremiumCountdown({ targetDate, onComplete, className = '' }) {
  ...
  const FlipCard = ({ value, label, prevValue }) => {
    ...
    return (
      <div className="flex flex-col items-center">
        ...
        <span className="text-xs md:text-sm text-gray-500 mt-2 uppercase tracking-widest font-medium">
          {label}
        </span>
      </div>
    )
  ...
  const Separator = () => (
    <div className="flex flex-col items-center justify-center gap-2 px-1 md:px-3">
