...
export default function GalleryPage() {
  ...
  // Total photo count (set after loading)
  ...
  const loadGallery = async () => {
    try {
      ...
      // Load ALL photos using batching (Supabase limits 1000 per request)
      let allPhotos = []
      let offset = 0
      ...
      // Use public URLs for watermarked images (no signed URLs needed)
      // Format: https://<project>.supabase.co/storage/v1/object/public/<bucket>/<path>
      const SUPABASE_URL = 'https://gonalgubgldgpkcekaxe.supabase.co'
      
      const photosWithUrls = allPhotos.map(photo => ({
        ...photo,
        watermarked_url: `${SUPABASE_URL}/storage/v1/object/public/galleries/${photo.watermarked_path}`,
        thumbnail_url: `${SUPABASE_URL}/storage/v1/object/public/galleries/${photo.watermarked_path}`,
